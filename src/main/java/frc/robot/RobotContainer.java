...
;
  ...
  private void configureBindings() {
    ...
    controller.a().onFalse(new ReverseNoteCommand(shooter, intake));

    controller.povUp().onTrue(shooter.setShooterCommand(-0.5));
    controller.povUp().onFalse(shooter.setShooterCommand(0));
    ...
    controller.rightBumper().onTrue(new InstantCommand(() -> pneumaticSubsystem.toggleSolenoid(), pneumaticSubsystem));
