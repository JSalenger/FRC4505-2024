...
public class AutoShootParkLeft extends SequentialCommandGroup {
    public AutoShootParkLeft(SwerveSubsystem swerve, ShooterSubsystem shooter, IntakeSubsystem intake) {
